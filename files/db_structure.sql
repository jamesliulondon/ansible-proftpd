...
GRANT ALL ON usertable TO proftpd@localhost IDENTIFIED BY 'proftpd';
GRANT ALL ON grouptable TO proftpd@localhost IDENTIFIED BY 'proftpd';
GRANT ALL ON xfer_stat TO proftpd@localhost IDENTIFIED BY 'proftpd';
